    ...
    shader_factory_(&shader_factory)
{
    ...
    emissive_shader->VertexShader.Set("assets/blinn-phong.vert");
    ...
    blinn_phong_shader->VertexShader.Set("assets/blinn-phong.vert");
    blinn_phong_shader->FragmentShader.Set("assets/blinn-phong.frag");
    ...
    blinn_phong_spotlight_shader->VertexShader.Set("assets/blinn-phong.vert");
    blinn_phong_spotlight_shader->FragmentShader.Set("assets/blinn-phong-spotlight.frag");
    ...
    toon_shader->VertexShader.Set("assets/blinn-phong.vert");
    toon_shader->FragmentShader.Set("assets/cartoon.frag");
   ...
   // Alpha shader and material
    ...
    alpha_shader->FragmentShader.Set("assets/alpha-test.frag");
